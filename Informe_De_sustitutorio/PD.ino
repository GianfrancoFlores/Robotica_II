...
// --- NUEVO: Variables para el Controlador PD del Servo ---
// Estas constantes Kp y Kd son el corazón del controlador.
// Deberás ajustarlas para obtener el mejor rendimiento.
// - Kp: Aumenta la velocidad de respuesta al error. Si es muy alto, puede oscilar.
// - Kd: Amortigua la respuesta. Ayuda a prevenir que se pase del objetivo.
float Kp = 0.07;
float Kd = 0.04;
...
void apagarFuegoPD() {
  ...
  posicion_servo = 90;
  servo.write(posicion_servo);
  error_previo = 0; // Reiniciar el error previo para la próxima activación
}
